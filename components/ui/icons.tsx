...
export function DashboardIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TransactionsIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AccountsIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M480-840 820-620H140L480-840Z" />
      <rect x="190" y="-580" width="90" height="420" />
      <rect x="435" y="-580" width="90" height="420" />
      <rect x="680" y="-580" width="90" height="420" />
      <rect x="120" y="-160" width="720" height="90" rx="14" />
    </svg>
  );
}

export function BudgetsIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SourcesIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M480-160 120-360l100-56 260 144 260-144 100 56L480-160Z" />
      <path d="M480-360 120-560l100-56 260 144 260-144 100 56L480-360Z" />
      <path d="M480-560 120-760l360-200 360 200-360 200Z" />
    </svg>
  );
}
...
export function LogOutIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M420-800H240V-160H420" />
      <path d="M300-480H700" />
      <path d="M580-600 700-480 580-360" />
    </svg>
  );
}
...
export function RefreshIcon({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M480-160q-134 0-227-93t-93-227q0-134 93-227t227-93q69 0 132 28.5T720-690v-110h80v280H520v-80h114q-42-51-101-80.5T480-720q-100 0-170 70t-70 170q0 100 70 170t170 70q77 0 139-44t87-116h84q-28 106-114 173t-196 67Z" />
    </svg>
  );
}
